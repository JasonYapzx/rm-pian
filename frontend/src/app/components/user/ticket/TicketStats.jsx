            ...
            <Grid container display={'inline-flex'}>
                ...
                <Grid item xs overflow={'hidden'} textOverflow={'ellipsis'}>
                    <Box sx={{ width: "100%", display: "flex", flexDirection: 'column' }}>
                        <Box display={'inline-flex'}>
                            ...
                            <Tooltip title="Last sale price for this Ticket"><HelpOutline fontSize='small' sx={{ color: "#9f9f9f" }} /></Tooltip>
                        </Box>
                ...
                <Grid item xs overflow={'hidden'} textOverflow={'ellipsis'}>
                    <Box sx={{ display: "flex", flexDirection: 'column' }}>
                        <Box display={'inline-flex'}>
                            <Typography variant='body2' color={"#9f9f9f"}>Last Sale &#40;Contract&#41;</Typography>
                            <Tooltip title="Last sale price for tickets in this token contract" ></Tooltip>
                        </Box>
                        <Typography>$160</Typography>
                    </Box>
                </Grid>
